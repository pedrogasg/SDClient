...
class SimpleClient(SDClient):
    ...
    def __init__(self, address, racer, vehicle, poll_socket_sleep_time=0.01):
        SDClient.__init__(*address, poll_socket_sleep_time=poll_socket_sleep_time)
    ...
    def on_msg_recv(self, json_packet):
        ...
        if json_packet['msg_type'] == "telemetry":
            ...
            self.last_image = cv2.imdecode(np.frombuffer(base64.b64decode(imgString)))
